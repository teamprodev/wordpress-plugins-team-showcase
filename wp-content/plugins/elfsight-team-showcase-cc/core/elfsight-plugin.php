...
if (!class_exists('ElfsightTeamShowcasePlugin')) {
    class ElfsightTeamShowcasePlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightTeamShowcasePluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightTeamShowcaseWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightTeamShowcasePluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightTeamShowcaseWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightTeamShowcaseVCElement($config, $this->widgetsApi);
